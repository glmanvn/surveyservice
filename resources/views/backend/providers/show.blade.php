                        ...
                        <form data-parsley-validate="" class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input type="text" class="form-control" value="{{ $provider->name }}" required />
                                </div>
                                <label class="control-label col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input type="text" class="form-control" value="{{ $provider->short_name }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input type="text" class="form-control" value="{{ $provider->brand_name }}" required>
                                </div>
                                <label class="control-label col-md-2 col-sm-2 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input type="text" class="form-control" value="{{ $provider->website }}">
                                </div>
                                <label class="control-label col-md-2 col-sm-2 col-xs-12">
                                    <?php echo Lang::get('title_master.providers_email'); ?>
                                </label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input type="text" class="form-control" value="{{ $provider->email }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12">
